...
(function() {
  var Calendar, TimeSlot, align, backgroundColor, borderColor, borderRadius, borderWeight, disableColor, disableOpacity, fadeOutTime, init2dArray, loadingImage, padding, source, top, width;
  ...
  $("button#make").live("click", function() {
  ...
  $("button#parse_calendar").live("click", function() {
    return modalPopup(align, top, width, padding, disableColor, disableOpacity, backgroundColor, borderColor, borderWeight, borderRadius, fadeOutTime, source, loadingImage);
  });

  $(document).keyup(function(e) {
    if (e.keyCode === 27) {
      return closePopup(fadeOutTime);
    }
  });
